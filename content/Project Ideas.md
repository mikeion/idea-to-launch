...
A collection of ideas we might develop into full projects.
...
- **Local Restaurant Randomizer** - When you can't decide where to eat

## Physical Product Ideas
- **Customized Map Art** - Places that are meaningful to customers
- **Daily Reflection Journal** - Structured journaling with prompts

## Ideas to Explore with Dataview
```dataview
TABLE WITHOUT ID
  idea as "Idea",
